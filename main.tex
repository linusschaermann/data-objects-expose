...
The term \ac{SIT} refers to the unauthorized use of hardware, software or cloud services within an organization without approval from the \ac{IT} department, potentially causing security risks, compliance issues or even data breaches \citep[145]{RN432}. With the rise of generative \ac{AI} technologies, such as large language models and \ac{AI}-powered tools, a new category of \ac{SIT} has emerged: \ac{SAI}. This term describes the use of generative \ac{AI} applications by employees without formal approval or oversight from the organization's \ac{IT} department \citep[1-2]{RN287}. \ac{SAI} can lead to similar risks as \ac{SIT}, such as data privacy concerns, security vulnerabilities and compliance issues, but it also introduces unique challenges due to the nature of generative \ac{AI} technologies.
